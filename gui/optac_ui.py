...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.live_recon = QtWidgets.QRadioButton(self.align_tab)
        self.live_recon.setGeometry(QtCore.QRect(980, 19, 151, 31))
        self.live_recon.setObjectName("live_recon")
        self.radon_idx = QtWidgets.QSpinBox(self.align_tab)
        ...
        self.flat_field_btn = QtWidgets.QPushButton(self.align_tab)
